...
void print_banner() {
    ...
    printf("    remote_file                  path to file on client\n");
    printf("    local_dest (optional)        local path to save file\n");
    printf("                                 (can be directory or full path)\n");
    printf("  upload <local_file> [remote_dest]    upload file to client\n");
    printf("    local_file                   path to file on server\n");
    printf("    remote_dest (optional)       path on client to save file\n");
    printf("                                 (can be directory or full path)\n");
    printf("\nExamples:\n");
    printf("  download /etc/passwd           download to current directory\n");
    printf("  download /etc/passwd ./files/  download to ./files/ directory\n");
    printf("  download /etc/passwd config.txt download as config.txt\n");
    printf("  upload test.txt               upload to client's current dir\n");
    printf("  upload test.txt /tmp/         upload to client's /tmp/ dir\n");
    printf("  upload test.txt /tmp/new.txt  upload as /tmp/new.txt\n");
    printf("\nNotes:\n");
